            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-600">50+ Professionals</div>
                </div>
              </div>
              <div className="flex items-center">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-indigo-500 to-blue-500 rounded-3xl p-8 text-white shadow-2xl">
              ...
              <p className="text-lg mb-6">
                To empower businesses with innovative technology solutions that create meaningful impact and drive sustainable growth in an ever-evolving digital landscape.
              </p>
              <div className="flex items-center">
